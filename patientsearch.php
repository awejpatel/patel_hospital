...
if(isset($_POST['patient_search_submit'])){
    ...
    $result  = mysqli_query($con,"select * from patreg where contact='$contact'");
    $row     = mysqli_fetch_array($result);
    if(empty($row['lname']) && empty($row['contact'])){
        ...
        <thead><tr><th>First Name</th><th>Last Name</th><th>Email</th><th>Contact</th></tr></thead>
        <tbody><tr>
